...
module Make_encoder(Encoder:Pbrt_json.Encoder_sig) : sig
  ...
  val encode_all_basic_types : all_basic_types -> Encoder.t -> unit
  (** [encode_all_basic_types v encoder] encodes [v] with the given [encoder] *)
  
  val encode_small_message : small_message -> Encoder.t -> unit
  ...
  val encode_single_one_of : single_one_of -> Encoder.t -> unit
  (** [encode_single_one_of v encoder] encodes [v] with the given [encoder] *)
  
  val encode_test : test -> Encoder.t -> unit
